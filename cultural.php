    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Cultural & Adventure Tour</h3>
            </div>
        </div>
        <!-- Header End -->

         <!-- Cultural & Adventure Tours Section Start -->
            <div class="container py-5">
                <div class="row g-4">
                    <!-- Card 1: Tanzania Cultural Tours -->
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card shadow h-100">
                            <img src="img/cu.jpg" class="card-img-top" alt="Tanzania Cultural Tours">
                            <div class="card-body text-center">
                                <h5 class="card-title">Tanzania Cultural Tours</h5>
                                <p class="card-text">Immerse yourself in authentic Maasai, Hadzabe, and Chaga traditions.</p>
                                <a href="Tanzania.php" class="btn btn-outline-primary rounded-circle">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                    <!-- Card 2: The Nocturnal Game Drive -->
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card shadow h-100">
                            <img src="img/31.jpeg" class="card-img-top" alt="Nocturnal Game Drive">
                            <div class="card-body text-center">
                                <h5 class="card-title">Nocturnal Game Drive</h5>
                                <p class="card-text">Explore Tanzania's wildlife after dark for a thrilling safari perspective.</p>
                                <a href="Nocturnal.php" class="btn btn-outline-primary rounded-circle">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                    <!-- Card 3: Biking Safari Activities -->
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card shadow h-100">
                            <img src="img/30.jpg" class="card-img-top" alt="Biking Safari">
                            <div class="card-body text-center">
                                <h5 class="card-title">Biking Safari Activities</h5>
                                <p class="card-text">Cycle through scenic savannahs, rural villages, and wildlife corridors.</p>
                                <a href="biking.php" class="btn btn-outline-primary rounded-circle">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                    <!-- Card 4: Bird Watch Trip -->
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card shadow h-100">
                            <img src="img/bird.jpg" class="card-img-top" alt="Bird Watch Trip">
                            <div class="card-body text-center">
                                <h5 class="card-title">Bird Watch Trip</h5>
                                <p class="card-text">Spot over 1,100 species in Tanzania’s forests, lakes, and savannahs.</p>
                                <a href="bird.php" class="btn btn-outline-primary rounded-circle">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
        ...
        <!-- Cultural & Adventure Tours Section End -->
