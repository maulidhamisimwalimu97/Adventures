    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">About Us</h3>
            </div>
        </div>
        <!-- Header End -->
              <!-- About Start -->
...
<div class="container-fluid country overflow-hidden py-5">
    <div class="container py-5">
        <div class="section-title text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 70px;">
            <div class="sub-style">
                <h5 class="sub-title text-primary px-3">OUR C.E.O</h5>
            </div>
            <h1 class="display-5 mb-4">Meet the Visionary Behind Our Journey</h1>
            <p class="mb-0">Leading with passion and purpose, our CEO is dedicated to delivering extraordinary adventures and unforgettable experiences across Tanzania and beyond.</p>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                <div class="country-item text-center">
                    <div class="rounded overflow-hidden">
                        <img src="img/jackie.jpg" class="img-fluid w-100 rounded" alt="CEO Image">
                    </div>
                    <div class="country-flag mt-3">

                    </div>
                    <div class="country-name mt-3">
                        <h4 class="text-white">Vickie Zegega</h4>
                        <p class="text-white mb-0">Chief Executive Officer</p>
                    </div>
                </div>
            </div>
        </div>
