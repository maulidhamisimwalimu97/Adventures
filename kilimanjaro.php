...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/27.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Mt Kilimanjaro Climbing</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Mt Kilimanjaro Climbing Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">$1200 per person</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">6 to 8 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Mountain Trekking & Climbing</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Mt Kilimanjaro, Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Mt Kilimanjaro Climbing Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Challenge yourself with the breathtaking Mt Kilimanjaro climb, Africa’s highest peak. Experience diverse ecosystems and stunning views, from rainforest to alpine desert, on this unforgettable trekking adventure.</p>

                        <h4 class="mt-5 mb-4">Highlights</h4>
                        <ul>
                            <li>Summit Uhuru Peak – Highest Point in Africa</li>
                            <li>Scenic Routes: Machame, Marangu, Rongai</li>
                            <li>Wildlife and Diverse Flora</li>
                            <li>Professional Guides and Support Team</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Sample Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival and Preparation in Moshi</li>
                            <li><strong>Day 2-7:</strong> Trekking to Summit via Chosen Route</li>
                            <li><strong>Day 8:</strong> Descent and Return to Moshi</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Park Fees, Accommodation on Trek, Meals, Professional Guides, Rescue Support</li>
                            <li><strong>Excluded:</strong> Flights, Personal Equipment, Tips, Travel Insurance</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🗻 <span class="text-warning">Book Your Climb</span></h2>
                            <p class="text-center text-muted mb-4">Secure your spot now for an unforgettable Mt Kilimanjaro experience!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Mt Kilimanjaro Climbing">
