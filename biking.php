...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/30.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Biking Safari Activities</h3>
            </div>
        </div>
        <!-- Header End -->

        <!-- Biking Safari Info Cards Start -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">$80 per person</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Half Day or Full Day</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            <i class="fas fa-biking fa-2x text-primary mb-2"></i>
                            <h5 class="card-title">Tour Type</h5>
                            <p class="card-text">Active & Scenic</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Mto wa Mbu & Lake Manyara</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <!-- Biking Safari Info Cards End -->
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p>Enjoy an adventurous biking tour through picturesque landscapes and vibrant local villages. This eco-friendly safari provides a close-up experience of nature, culture, and daily life in Tanzania.</p>
                    
                    <h4 class="mt-5 mb-4">Areas to Visit</h4>
                    <ul>
                        <li>Mto wa Mbu Village</li>
                        <li>Lake Manyara surroundings</li>
                        <li>Banana & Rice Plantations</li>
                    </ul>

                    <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                    <ol>
                        <li><strong>Morning:</strong> Meet-up & Safety Briefing</li>
                        <li><strong>Midday:</strong> Biking Through Scenic Routes</li>
                        <li><strong>Afternoon:</strong> Cultural Interaction & Refreshments</li>
                    </ol>

                    <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                    <ul>
                        <li><strong>Included:</strong> Bicycles, Helmets, Local Guide, Water, Snacks</li>
                        <li><strong>Excluded:</strong> Tips, Personal Expenses, Insurance</li>
                    </ul>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="bg-white rounded-4 shadow-lg p-5">
                        ...
                        <div class="row g-3">
                            <!-- Hidden Tour Name -->
                            <input type="hidden" name="tour_name" value="Biking Safari Activities">
