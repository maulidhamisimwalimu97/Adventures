...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/mikumi.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Mikumi, Ruaha & Selous</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Southern Circuit Safari Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">3 to 6 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Wildlife Safari</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Southern Tanzania Circuit</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Southern Circuit Safari Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Discover the hidden gems of Southern Tanzania with a thrilling safari through Mikumi, Ruaha, and Selous Game Reserve. These parks offer untouched wilderness, fewer crowds, and incredible wildlife experiences including lions, elephants, hippos, and rare bird species.</p>

                        <h4 class="mt-5 mb-4">Parks to Visit</h4>
                        <ul>
                            <li>Mikumi National Park</li>
                            <li>Ruaha National Park</li>
                            <li>Selous Game Reserve (Nyerere National Park)</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival & Transfer to Mikumi</li>
                            <li><strong>Day 2:</strong> Game Drives in Mikumi</li>
                            <li><strong>Day 3-4:</strong> Explore Ruaha's vast wilderness</li>
                            <li><strong>Day 5-6:</strong> Safari and Boat Tour in Selous</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Park Fees, Accommodation, 4x4 Vehicle, Guide, Meals</li>
                            <li><strong>Excluded:</strong> International Flights, Tips, Personal Insurance</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Mikumi, Ruaha & Selous">
