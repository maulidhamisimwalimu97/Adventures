...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/24.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Mafia Island</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Mafia Island Safari Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">$150 per person</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">3 to 5 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Beach & Marine Safari</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Mafia Island, Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Mafia Island Safari Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Discover the pristine beaches, coral reefs, and rich marine biodiversity of Mafia Island. Enjoy snorkeling, diving, and whale shark watching in a serene and less crowded paradise.</p>

                        <h4 class="mt-5 mb-4">Parks to Visit</h4>
                        <ul>
                            <li>Mafia Island Marine Park</li>
                            <li>Mnazi Bay-Ruvuma Estuary Marine Park</li>
                            <li>Jibondo Island</li>
                            <li>Kibiti Mangrove Forest</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival & Transfer to Mafia Island</li>
                            <li><strong>Day 2-4:</strong> Snorkeling, Diving & Marine Wildlife Excursions</li>
                            <li><strong>Day 5:</strong> Visit Local Villages & Cultural Tour</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Accommodation, Boat Transfers, Guide, Meals, Marine Park Fees</li>
                            <li><strong>Excluded:</strong> International Flights, Tips, Personal Insurance, Diving Equipment Rental</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🎉 <span class="text-warning">30% Off</span> Your First Mafia Island Safari</h2>
                            <p class="text-center text-muted mb-4">Enjoy a special discount for first-time visitors!</p>

                        <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Mafia Island">
