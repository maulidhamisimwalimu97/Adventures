...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/3.jpeg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Zanzibar Island</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Zanzibar Island & Beaches Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">$220 per person</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">3 to 7 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Island & Beach Relaxation</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Zanzibar Island, Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Zanzibar Island & Beaches Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Discover the idyllic paradise of Zanzibar Island with its pristine white sandy beaches, turquoise waters, and rich cultural heritage. Enjoy a perfect blend of relaxation, adventure, and history on this tropical getaway.</p>

                        <h4 class="mt-5 mb-4">Highlights</h4>
                        <ul>
                            <li>Stone Town – UNESCO World Heritage Site</li>
                            <li>Nungwi and Kendwa Beaches</li>
                            <li>Snorkeling and Diving in Mnemba Atoll</li>
                            <li>Spice Tours and Local Markets</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Sample Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival and Transfer to Stone Town</li>
                            <li><strong>Day 2:</strong> Stone Town Walking Tour and Spice Farm Visit</li>
                            <li><strong>Day 3-5:</strong> Beach Time at Nungwi and Kendwa, Water Sports</li>
                            <li><strong>Day 6:</strong> Snorkeling/Diving Excursion to Mnemba Atoll</li>
                            <li><strong>Day 7:</strong> Leisure Day & Departure</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Accommodation, Airport Transfers, Guided Tours, Meals, Water Sports Equipment</li>
                            <li><strong>Excluded:</strong> International Flights, Travel Insurance, Personal Expenses</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🌴 <span class="text-warning">30% Off</span> Early Bird Special</h2>
                            <p class="text-center text-muted mb-4">Book early and enjoy exclusive savings on your Zanzibar escape!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Zanzibar Island">
