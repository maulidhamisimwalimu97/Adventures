    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Mountain Trekking</h3>
            </div>
        </div>
        <!-- Header End -->


    <!-- Mountain Trekking Section Start -->
    <div class="container py-5">
        <div class="row g-4">
            <!-- Card 1 -->
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card shadow h-100">
                    <img src="img/27.jpg" class="card-img-top" alt="Mt Kilimanjaro Climbing">
                    <div class="card-body text-center">
                        <h5 class="card-title">Mt Kilimanjaro Climbing</h5>
                        <p class="card-text">Embark on a life-changing journey to Africa’s tallest mountain.</p>
                        <a href="kilimanjaro.php" class="btn btn-outline-primary rounded-circle">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card shadow h-100">
                    <img src="img/28.jpg" class="card-img-top" alt="Trekking and Hiking Tours">
                    <div class="card-body text-center">
                        <h5 class="card-title">Trekking & Hiking Tours</h5>
                        <p class="card-text">Discover scenic trails and nature-packed adventures across Tanzania.</p>
                        <a href="Trekking.php" class="btn btn-outline-primary rounded-circle">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card shadow h-100">
                    <img src="img/29.jpeg" class="card-img-top" alt="Walking Safari">
                    <div class="card-body text-center">
                        <h5 class="card-title">Tanzania Walking Safari</h5>
                        <p class="card-text">Walk through the wild with expert rangers and immersive nature views.</p>
                        <a href="Tanzania_Walking.php" class="btn btn-outline-primary rounded-circle">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card shadow h-100">
                    <img src="img/29.jpg" class="card-img-top" alt="Mt Meru Climbing">
                    <div class="card-body text-center">
                        <h5 class="card-title">Mt Meru Climbing</h5>
                        <p class="card-text">Scale Tanzania’s second highest peak with panoramic views and wildlife.</p>
                        <a href="Meru.php" class="btn btn-outline-primary rounded-circle">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
