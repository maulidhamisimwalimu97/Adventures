...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/buffalo.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Northren Circuit Safari</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Northern Circuit Safari Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Northern Tanzania Circuit</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Northern Circuit Safari Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Embark on an unforgettable wildlife adventure across Tanzania’s renowned Northern Safari Circuit. From the vast plains of the Serengeti to the dramatic Ngorongoro Crater, witness the Big Five and immerse yourself in East Africa's raw beauty.</p>
                        ...
                        <ol>
                            <li><strong>Day 1:</strong> Arrival & Transfer to Tarangire</li>
                            <li><strong>Day 2-3:</strong> Game Drives in Serengeti</li>
                            <li><strong>Day 4:</strong> Ngorongoro Crater Exploration</li>
                            <li><strong>Day 5:</strong> Lake Manyara Safari & Departure</li>
                        </ol>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            ...
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Northern Circuit Safari">
