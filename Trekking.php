...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/2.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Trekking & Hiking Tours</h3>
            </div>
        </div>
        <!-- Header End -->


            <!-- Trekking & Hiking Tours Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Adventure & Nature Trekking</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Mount Kilimanjaro, Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Trekking & Hiking Tours Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Embark on an unforgettable adventure trekking through the breathtaking landscapes of Mount Kilimanjaro. Experience diverse ecosystems, challenging trails, and stunning views on Africa’s highest peak.</p>

                        <h4 class="mt-5 mb-4">Highlights</h4>
                        <ul>
                            <li>Summit Uhuru Peak – The Roof of Africa</li>
                            <li>Explore the Machame and Marangu routes</li>
                            <li>Wildlife spotting and forest hikes</li>
                            <li>Breathtaking sunrise from Stella Point</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Sample Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival and Preparation in Moshi</li>
                            <li><strong>Day 2-6:</strong> Trekking via Machame or Marangu Route</li>
                            <li><strong>Day 7:</strong> Summit Attempt and Descent</li>
                            <li><strong>Day 8:</strong> Rest Day and Cultural Tour</li>
                            <li><strong>Day 9:</strong> Departure</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Park Fees, Camping Equipment, Guides, Meals, Transfers</li>
                            <li><strong>Excluded:</strong> International Flights, Personal Gear, Tips, Travel Insurance</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🥾 <span class="text-warning">20% Off</span> Early Bird Special</h2>
                            <p class="text-center text-muted mb-4">Reserve your spot now and save on your Kilimanjaro trekking adventure!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Trekking & Hiking Tours">
