    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Tanzania Cultural Tours</h3>
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">$99 per person</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Cultural & Adventure</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Arusha & Surrounding Villages</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p>Experience the true essence of Tanzania through cultural immersion with local tribes. Engage in traditional dances, local food, and authentic village life.</p>
                    
                    <h4 class="mt-5 mb-4">Areas to Visit</h4>
                    <ul>
                        <li>Maasai Village Visit</li>
                        <li>Local Craft Markets</li>
                        <li>Arusha Cultural Center</li>
                    </ul>

                    <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                    <ol>
                        <li><strong>Day 1:</strong> Arrival & Village Tour</li>
                        <li><strong>Day 2:</strong> Cultural Activities & Storytelling</li>
                        <li><strong>Day 3:</strong> Farewell Ceremony & Departure</li>
                    </ol>

                    <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                    <ul>
                        <li><strong>Included:</strong> Accommodation, Meals, Tour Guide</li>
                        <li><strong>Excluded:</strong> International Flights, Personal Expenses</li>
                    </ul>
                </div>
                <!-- Right Booking Form -->
                <div class="col-lg-5">
                    <div class="bg-white rounded-4 shadow-lg p-5">
                        ...
                        <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Tanzania Cultural Tours">
