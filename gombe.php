...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/23.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Gombe & Saadani Parks</h3>
            </div>
        </div>
        <!-- Header End -->

          <!-- Gombe and Saadani Safari Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">2 to 5 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                <i class="fas fa-binoculars fa-2x text-primary mb-2"></i>
                                <h5 class="card-title">Tour Type</h5>
                                <p class="card-text">Chimpanzee Tracking & Beach Safari</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Western & Coastal Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Gombe and Saadani Safari Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Discover the hidden gems of Tanzania in Gombe and Saadani National Parks. Track wild chimpanzees in the lush forests of Gombe and enjoy a unique beach-and-bush experience in Saadani where wildlife meets the Indian Ocean shoreline.</p>
                        ...
                        <ol>
                            <li><strong>Day 1:</strong> Arrival in Kigoma & Transfer to Gombe</li>
                            <li><strong>Day 2:</strong> Chimpanzee Trekking</li>
                            <li><strong>Day 3:</strong> Travel to Saadani via Dar es Salaam</li>
                            <li><strong>Day 4:</strong> Game Drive & Beach Relaxation</li>
                            <li><strong>Day 5:</strong> Morning Safari & Departure</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Park Fees, Boat Transfers, Local Flights, Accommodation, Guide, Meals</li>
                            <li><strong>Excluded:</strong> International Flights, Tips, Personal Insurance, Drinks</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Gombe & Saadani Parks">
