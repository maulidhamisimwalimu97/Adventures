...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/wilds.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Wildlife Safaris & Parks</h3>
            </div>
        </div>         
        <!-- Header End -->

        
        <!-- Wildlife Safaris & Parks Section Start -->
        <div class="container py-5">
            <div class="row g-4">
                <!-- Card 1 -->
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card shadow h-100">
                        <img src="img/20.jpg" class="card-img-top" alt="Northern Circuit Safari">
                        <div class="card-body text-center">
                            <h5 class="card-title">Northern Circuit Safari</h5>
                            <p class="card-text">Explore Serengeti, Ngorongoro, Lake Manyara & Tarangire in one epic safari journey.</p>
                            <a href="Northern.php" class="btn btn-outline-primary rounded-circle">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card shadow h-100">
                        <img src="img/21.jpg" class="card-img-top" alt="Southern Safari Parks">
                        <div class="card-body text-center">
                            <h5 class="card-title">Mikumi, Ruaha & Selous</h5>
                            <p class="card-text">Uncover Tanzania's wild side with remote game drives and big cat encounters.</p>
                            <a href="mikumi.php" class="btn btn-outline-primary rounded-circle">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card shadow h-100">
                        <img src="img/22.jpg" class="card-img-top" alt="Great Migration Safari">
                        <div class="card-body text-center">
                            <h5 class="card-title">Masai Mara & Great Migration</h5>
                            <p class="card-text">Witness the world’s most spectacular migration in the savannah plains of East Africa.</p>
                            <a href="masai.php" class="btn btn-outline-primary rounded-circle">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card shadow h-100">
                        <img src="img/23.jpg" class="card-img-top" alt="Gombe and Saadani Parks">
                        <div class="card-body text-center">
                            <h5 class="card-title">Gombe & Saadani Parks</h5>
                            <p class="card-text">Track chimps in Gombe and enjoy beachside safaris in Saadani National Park.</p>
                            <a href="gombe.php" class="btn btn-outline-primary rounded-circle">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
        ...
        <!-- Wildlife Safaris & Parks Section End -->
