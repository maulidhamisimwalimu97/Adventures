...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/26.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Marine Adventures</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Marine Adventures Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Marine Wildlife & Adventure</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Indian Ocean Coast, Kenya & Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Marine Adventures Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Explore the stunning Indian Ocean coastline, rich with vibrant marine life and pristine beaches. Dive into coral reefs, snorkel with tropical fish, and enjoy boat safaris to spot dolphins, whales, and turtles.</p>

                        <h4 class="mt-5 mb-4">Destinations to Explore</h4>
                        <ul>
                            <li>Watamu Marine National Park</li>
                            <li>Mombasa Marine Reserve</li>
                            <li>Mnemba Atoll, Zanzibar</li>
                            <li>Pemba Island</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Sample Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival & Beach Welcome</li>
                            <li><strong>Day 2-4:</strong> Snorkeling, Scuba Diving & Boat Tours</li>
                            <li><strong>Day 5:</strong> Marine Conservation Tour & Beach Relaxation</li>
                            <li><strong>Day 6:</strong> Optional Deep-Sea Fishing or Sailing Adventure</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Accommodation, Diving Gear, Guided Tours, Boat Transfers, Meals</li>
                            <li><strong>Excluded:</strong> International Flights, Diving Certification Fees, Personal Insurance</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🌊 <span class="text-info">30% Off</span> Early Bird Discount</h2>
                            <p class="text-center text-muted mb-4">Book early and dive into adventure with a special discount!</p>

                        <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Marine Adventures">
