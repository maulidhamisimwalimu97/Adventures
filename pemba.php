...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/25.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Pemba Island</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Pemba Island Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Pemba Island, Zanzibar, Tanzania</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Pemba Island Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Discover the tranquil beauty of Pemba Island, known for its pristine beaches, coral reefs, and rich marine biodiversity. Enjoy snorkeling, diving, and cultural experiences in this peaceful paradise.</p>

                        <h4 class="mt-5 mb-4">Places to Visit</h4>
                        <ul>
                            <li>Wawi Beach</li>
                            <li>Misali Island Marine Park</li>
                            <li>Chake Chake Town</li>
                            <li>Matemwe Village</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival & Relax at Wawi Beach</li>
                            <li><strong>Day 2-4:</strong> Snorkeling, Diving & Marine Park Visits</li>
                            <li><strong>Day 5:</strong> Explore Chake Chake & Local Culture</li>
                            <li><strong>Day 6:</strong> Beach Relaxation & Departure</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Accommodation, Boat Trips, Guide, Meals, Marine Park Fees</li>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🎉 <span class="text-warning">30% Off</span> Your Pemba Adventure</h2>
                            <p class="text-center text-muted mb-4">Book now for a tropical getaway!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Pemba Island">
