...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/29.jpeg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Tanzania Walking Safaris</h3>
            </div>
        </div>
        <!-- Header End -->

           <!-- Tanzania Walking Safaris Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">$350 per person</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">5 to 10 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Walking Safari & Wildlife Adventure</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Northern Tanzania Parks</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Tanzania Walking Safaris Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Experience Tanzania’s breathtaking wilderness on foot. Explore the untouched beauty of the Northern Circuit's iconic parks, getting closer to nature and wildlife than ever before. This walking safari offers adventure, tranquility, and authentic encounters with the African bush.</p>

                        <h4 class="mt-5 mb-4">Highlights</h4>
                        <ul>
                            <li>Guided walking safaris through Tarangire, Lake Manyara, and Ngorongoro Crater</li>
                            <li>Witness wildlife up close with expert guides</li>
                            <li>Scenic views and spectacular landscapes</li>
                            <li>Traditional Maasai village visits and cultural experiences</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Sample Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival in Arusha & Welcome Briefing</li>
                            <li><strong>Day 2-3:</strong> Walking Safari in Tarangire National Park</li>
                            <li><strong>Day 4-5:</strong> Lake Manyara Walking Safari & Maasai Village Visit</li>
                            <li><strong>Day 6-7:</strong> Ngorongoro Crater Exploration on Foot</li>
                            <li><strong>Day 8:</strong> Departure or Optional Extensions</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Accommodation, Park Fees, Guided Walking Safaris, Meals, Transfers</li>
                            <li><strong>Excluded:</strong> International Flights, Travel Insurance, Personal Expenses, Tips</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🌿 <span class="text-success">20% Off</span> Early Bird Offer</h2>
                            <p class="text-center text-muted mb-4">Reserve your walking safari now and save!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Tanzania Walking Safari">
