...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/22.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Masai Mara & Great Migration</h3>
            </div>
        </div>
        <!-- Header End -->

            <!-- Masai Mara & Great Migration Safari Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">$180 per person</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">4 to 8 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Great Migration Safari</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Masai Mara National Reserve, Kenya</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Masai Mara & Great Migration Safari Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Experience the awe-inspiring Great Migration in Kenya's Masai Mara National Reserve. Witness millions of wildebeest, zebras, and gazelles as they cross the Mara River, a breathtaking natural spectacle combined with rich wildlife viewing.</p>

                        <h4 class="mt-5 mb-4">Parks to Visit</h4>
                        <ul>
                            <li>Masai Mara National Reserve</li>
                            <li>Serengeti National Park (Tanzania)</li>
                            <li>Loita Hills</li>
                            <li>Lake Victoria Region</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrival & Transfer to Masai Mara</li>
                            <li><strong>Day 2-5:</strong> Great Migration Game Drives & River Crossings</li>
                            <li><strong>Day 6:</strong> Visit Local Maasai Villages & Cultural Experiences</li>
                            <li><strong>Day 7:</strong> Optional Hot Air Balloon Safari & Departure</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Park Fees, Accommodation, 4x4 Vehicle, Guide, Meals, Cultural Visits</li>
                            <li><strong>Excluded:</strong> International Flights, Tips, Personal Insurance, Balloon Safari (Optional)</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🎉 <span class="text-warning">50% Off</span> Your First Safari</h2>
                            <p class="text-center text-muted mb-4">A special discount for first-time adventurers!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Masai Mara & Great Migration">
