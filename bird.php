    ...
    <body>
       <!-- Spinner Start -->
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/bird.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Bird Watch Trip</h3>
            </div>
        </div>
        <!-- Header End -->

        <!-- Bird Watch Trip Info Cards Start -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">$70 per person</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Half Day / Full Day</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Nature & Observation</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow h-100 p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Lake Manyara & Surroundings</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <!-- Bird Watch Trip Info Cards End -->
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p>Delight in a serene birdwatching experience led by expert guides. Observe a rich variety of bird species in their natural habitat, from colorful flamingos to majestic eagles around Lake Manyara and lush forested areas.</p>

                    <h4 class="mt-5 mb-4">Areas to Visit</h4>
                    <ul>
                        <li>Lake Manyara National Park</li>
                        <li>Groundwater Forests</li>
                        <li>Mto wa Mbu Wetlands</li>
                    </ul>

                    <h4 class="mt-5 mb-4">Brief Itinerary</h4>
                    <ol>
                        <li><strong>Morning:</strong> Early Start, Bird Spotting at Lake Shore</li>
                        <li><strong>Midday:</strong> Picnic Break & Continued Exploration</li>
                        <li><strong>Afternoon:</strong> Forest Trail & Local Wetlands Visit</li>
                    </ol>

                    <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                    <ul>
                        <li><strong>Included:</strong> Binoculars, Park Entry Fees, Birding Guide, Refreshments</li>
                        <li><strong>Excluded:</strong> Personal Gear, Accommodation, Insurance</li>
                    </ul>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="bg-white rounded-4 shadow-lg p-5">
                        ...
                        <div class="row g-3">
                            <!-- Hidden Tour Name -->
                            <input type="hidden" name="tour_name" value="Bird Watch Trip">
