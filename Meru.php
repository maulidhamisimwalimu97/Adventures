...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative text-white"
            style="background: url('img/29.jpg') no-repeat center center; background-size: cover; height: 400px;">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center"
                ...
                <h3 class="display-3 text-white mb-4">Mt Meru Climbing</h3>
            </div>
        </div>
        <!-- Header End -->

          <!-- Mt Meru Climbing Info Cards Start -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">$580 per person</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">3 to 4 Days</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="card shadow h-100 p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Mountain Trekking Adventure</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
            ...
            <!-- Mt Meru Climbing Info Cards End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>Embark on an unforgettable adventure to the summit of Mt Meru, Tanzania’s second highest mountain. Experience stunning views, diverse wildlife, and a rewarding climb that prepares you for Kilimanjaro or stands strong on its own.</p>

                        <h4 class="mt-5 mb-4">Highlights</h4>
                        <ul>
                            <li>Scenic trek through Arusha National Park</li>
                            <li>Abundant wildlife including giraffes, buffalos, and monkeys</li>
                            <li>Stunning views of Kilimanjaro from the summit</li>
                            <li>Overnight stays in mountain huts</li>
                        </ul>

                        <h4 class="mt-5 mb-4">Sample Itinerary</h4>
                        <ol>
                            <li><strong>Day 1:</strong> Arrive in Arusha, Pre-climb Briefing</li>
                            <li><strong>Day 2:</strong> Drive to Momella Gate – Trek to Miriakamba Hut</li>
                            <li><strong>Day 3:</strong> Trek to Saddle Hut – Optional Little Meru Climb</li>
                            <li><strong>Day 4:</strong> Summit Mt Meru & descend to Momella Gate</li>
                        </ol>

                        <h4 class="mt-5 mb-4">Inclusions / Exclusions</h4>
                        <ul>
                            <li><strong>Included:</strong> Park Fees, Professional Guide, Accommodation in Huts, Meals, Transport</li>
                            <li><strong>Excluded:</strong> Flights, Travel Insurance, Tips, Personal Gear</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white rounded-4 shadow-lg p-5">
                            <h2 class="text-center text-dark mb-3">🧗‍♂️ <span class="text-warning">Book Now & Save 25%</span></h2>
                            <p class="text-center text-muted mb-4">Reserve your Mt Meru adventure today and enjoy exclusive early bird discounts!</p>

                            <form method="POST">
                            <div class="row g-3">
                                <!-- Hidden Tour Name -->
                                <input type="hidden" name="tour_name" value="Mt Meru Climbing">
